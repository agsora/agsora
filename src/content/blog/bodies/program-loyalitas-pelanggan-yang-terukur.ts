...
export const body: Block[] = [
  ...
  { type: "h2", text: "Hormati data pelanggan yang dikumpulkan" },
  {
    type: "p",
    text: "Program loyalitas mengumpulkan data pribadi dan riwayat belanja pelanggan yang cukup detail. Jelaskan dengan jelas kepada pelanggan data apa saja yang dikumpulkan dan untuk keperluan apa, berikan pilihan yang mudah bagi mereka untuk berhenti menerima pesan promosi jika tidak menginginkannya, dan pastikan seluruh pengelolaan data ini sesuai dengan ketentuan pelindungan data pribadi yang berlaku.",
  },
  { type: "h2", text: "Menyesuaikan program seiring waktu" },
  {
    type: "p",
    text: "Program loyalitas yang efektif bukan sesuatu yang diluncurkan sekali lalu dibiarkan berjalan tanpa perubahan selamanya. Tinjau kembali secara berkala apakah mekanismenya masih relevan dengan perilaku pelanggan saat ini, dan jangan ragu menyesuaikan struktur program berdasarkan data yang terkumpul, meski itu berarti mengubah sesuatu yang sudah dikenal pelanggan selama bertahun-tahun.",
  },
  { type: "h2", text: "Langkah merancang program loyalitas yang terukur" },
  {
    type: "ol",
    items: [
      "Tentukan tujuan spesifik yang ingin dicapai dari program ini",
      "Pilih mekanisme yang sesuai dengan tujuan tersebut",
      "Integrasikan program dengan sistem kasir agar data tercatat otomatis",
      "Bandingkan perilaku pelanggan sebelum dan sesudah bergabung secara berkala",
      "Hitung biaya program secara menyeluruh, termasuk poin yang belum ditukar",
  ...
  {
    type: "p",
    text: "Paling efektif untuk bisnis dengan pola pembelian berulang, seperti kebutuhan sehari-hari, kuliner, atau kosmetik. Untuk bisnis dengan pembelian yang sangat jarang terjadi, manfaatnya mungkin kurang signifikan dibanding biaya yang dikeluarkan untuk menjalankannya.",
  },
  { type: "h3", text: "Berapa lama waktu yang dibutuhkan untuk melihat hasil evaluasi program yang berarti?" },
  {
    type: "p",
    text: "Umumnya butuh setidaknya beberapa bulan data untuk melihat pola perilaku member secara jelas, dan idealnya evaluasi dilakukan secara berkelanjutan setiap beberapa bulan, bukan hanya sekali di awal peluncuran.",
  },
  { type: "h2", text: "Penutup" },
  {
    type: "p",
    text: "Program loyalitas yang baik bukan sekadar kartu member dan sistem poin yang terlihat menarik, melainkan strategi yang bisa diukur dampaknya secara konkret terhadap perilaku belanja pelanggan. Dengan data yang tercatat rapi dan evaluasi yang rutin, Anda bisa memastikan program ini benar-benar menguntungkan bisnis, bukan sekadar biaya tersembunyi yang terus berjalan tanpa hasil yang jelas.",
  },
  {
    type: "cta",

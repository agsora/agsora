...
export const body: Block[] = [
  ...
  { type: "h2", text: "Mulai dari satu kebutuhan yang paling bernilai" },
  {
    type: "p",
    text: "Bagi banyak firma jasa profesional, pencatatan waktu dan penagihan adalah titik awal yang paling bernilai untuk diterapkan lebih dulu. Setelah data waktu kerja terkumpul secara rutin dan konsisten, laporan profitabilitas dan perencanaan kapasitas tim bisa dibangun di atas fondasi data yang sudah kuat ini, tanpa harus menerapkan semua fitur sekaligus sejak awal.",
  },
  { type: "h2", text: "Langkah menerapkan sistem untuk bisnis jasa profesional" },
  {
    type: "ol",
    items: [
      "Mulai dari penerapan pencatatan waktu kerja yang mudah dan konsisten",
      "Hubungkan pencatatan waktu dengan sistem penagihan yang dipakai",
      "Tetapkan proses persetujuan untuk pekerjaan di luar ruang lingkup awal",
      "Bangun laporan profitabilitas per project dan per klien",
  ...
  {
    type: "p",
    text: "Jelaskan manfaatnya bagi mereka juga — data ini membantu membuktikan beban kerja mereka yang sebenarnya, yang berguna saat negosiasi penambahan tim atau penyesuaian target. Pastikan juga proses pencatatannya semudah mungkin, idealnya hanya butuh beberapa detik setiap kali berpindah tugas.",
  },
  { type: "h3", text: "Apakah cocok untuk firma kecil dengan hanya beberapa orang?" },
  {
    type: "p",
  ...
  {
    type: "cta",
    title: "Tahu berapa keuntungan sebenarnya dari setiap project yang dikerjakan?",
    text: "Diskusikan kebutuhan sistem operasional untuk bisnis jasa profesional Anda bersama tim AG·SORA.",
    href: "/contact",

...
/** The original ten articles, moved here unchanged from config/blog.ts. */
export const posts: PostSource[] = [
  {
    ...
    body: [
      ...
      {
        type: "h2",
        text: "1. Laporan bulanan selalu terlambat"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "2. Angka stok di sistem berbeda dengan fisik"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "3. Satu transaksi diinput berkali-kali"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "4. Keputusan diambil dari data minggu lalu"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "5. Menambah cabang terasa jauh lebih berat"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "6. Terlalu bergantung pada satu orang"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "7. Spreadsheet mulai saling menyalin"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Yang perlu disiapkan sebelum mulai"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Keduanya punya tempat masing-masing. Yang menentukan bukan anggaran, tapi seberapa unik proses bisnis Anda dan seberapa cepat Anda butuh berjalan.",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Pilih software jadi ketika…"
      },
      {
        type: "ul",
        items: [
      ...
      {
        type: "h2",
        text: "Pilih custom development ketika…"
      },
      {
        type: "ul",
        items: [
      ...
      {
        type: "h2",
        text: "Biaya yang sering tidak dihitung"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Sistem kasir yang bekerja baik di satu toko belum tentu sanggup menangani lima. Ini yang berubah ketika outlet bertambah.",
    category: "POS & Retail",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Kemampuan yang jadi wajib setelah outlet bertambah"
      },
      {
        type: "h3",
        text: "Konsolidasi laporan otomatis"
      },
      {
        type: "p",
      ...
      {
        type: "h3",
        text: "Stok per lokasi, bukan stok global"
      },
      {
        type: "p",
      ...
      {
        type: "h3",
        text: "Transfer antar outlet yang tercatat"
      },
      {
        type: "p",
      ...
      {
        type: "h3",
        text: "Tetap jalan saat internet mati"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Pertimbangan yang muncul belakangan"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Sistem HR gagal biasanya bukan karena fiturnya kurang, tapi karena penerapannya melewatkan hal-hal yang tampak sepele.",
    category: "HR & Tim",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Menyalin aturan yang belum jelas"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Mengabaikan pengecualian yang nyata"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Menganggap pelatihan sebagai formalitas"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Melupakan siapa pemilik datanya"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Angka penawaran hanya sebagian dari total biaya. Ini komponen yang sering baru muncul setelah project berjalan.",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Biaya yang sering terlewat"
      },
      {
        type: "h3",
        text: "Waktu tim internal Anda"
      },
      {
        type: "p",
      ...
      {
        type: "h3",
        text: "Pembersihan dan migrasi data"
      },
      {
        type: "p",
      ...
      {
        type: "h3",
        text: "Penurunan produktivitas saat transisi"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Cara membandingkan yang lebih adil"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Ketika setiap divisi punya catatan sendiri, biayanya tidak muncul sebagai tagihan — melainkan sebagai waktu, selisih, dan keputusan yang meleset.",
    category: "ERP & Operasional",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Menyelesaikannya secara bertahap"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Migrasi data adalah bagian yang paling sering diremehkan dan paling sering menunda peluncuran. Ini cara menyiapkannya.",
    category: "Teknologi",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Tentukan data mana yang benar-benar dibawa"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Bersihkan sebelum dipindahkan"
      },
      {
        type: "ul",
        items: [
      ...
      {
        type: "h2",
        text: "Uji dengan data sungguhan"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Bukan soal mengganti orang, tapi memindahkan pekerjaan berulang yang menghabiskan waktu tanpa menambah nilai.",
    category: "Teknologi",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Mulai dari pekerjaan yang paling sering diulang"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Tetapkan batas sejak awal"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Yang membedakan vendor bukan portofolio yang paling banyak, tapi kejelasan cara mereka bekerja dan jujur soal batasannya.",
    category: "Panduan Memilih",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Cara mereka menanggapi kebutuhan Anda"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Apa yang terjadi setelah rilis"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Dokumentasi dan serah terima"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Komunikasi selama pengerjaan"
      },
      {
        type: "p",
  ...
  },
  {
    ...
    excerpt: "Kegagalan jarang disebabkan oleh pilihan teknologi. Penyebabnya biasanya sudah ada sejak sebelum baris kode pertama ditulis.",
    category: "Strategi Bisnis",
    ...
    body: [
      ...
      {
        type: "h2",
        text: "Masalah yang dipecahkan tidak jelas"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Orang yang paling paham prosesnya tidak dilibatkan"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Ruang lingkup terlalu besar untuk sekali jalan"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Perubahan kebutuhan tidak dikelola"
      },
      {
        type: "p",
      ...
      {
        type: "h2",
        text: "Adopsi tidak direncanakan"
      },
      {
        type: "p",
